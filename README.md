...
# Задание 5: Провести замеры алгоритмической и пространственной сложности быстрой сортировки
...
```
2. Функция измерения алгоритмической сложности и пространственной сложности
```cpp
#include <chrono>
